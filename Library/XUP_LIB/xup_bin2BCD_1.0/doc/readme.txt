...
Introduction:
This IP is a member of XUP_LIB created by XUP. This IP provides Binary to BCD conversion. The Binary input width is constrained between 3 and 8 bits using SIZE as a configurable parameter. Depending on the width, tens and hundreds ports may become visible.  
...
SIZE - constrained between 3 and 8. Size of 4, 5, or 6 will make tens port visible. Size of 7 or 8 will make hundreds port visible.
Input:
a_in - Binary input
Output:
ones - ones output
