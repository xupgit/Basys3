...
Input Ports: 
lt_n : Lamp-Test (Active Low) Input
rbi_n : Ripple-Blanking (Active Low) Input
BCD_d,BCD_c,BCD_b,BCD_a
 : BCD Inputs
...
Inout Ports:
bi_rbo_n : Blanking Input or RippleBlanking Output (Active Low)
